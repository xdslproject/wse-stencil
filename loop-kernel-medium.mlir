builtin.module {
  func.func @loop_kernel_medium(%a : !stencil.field<[-1,#x_dim_pad]x[-1,#y_dim_pad]x[-1,#z_dim_pad]xf32>, %b : !stencil.field<[-1,#x_dim_pad]x[-1,#y_dim_pad]x[-1,#z_dim_pad]xf32>) {
