builtin.module {
  func.func @diffusion_small(%u_vec0 : !stencil.field<[-4,100]x[-4,100]x[-4,704]xf32>, %u_vec1 : !stencil.field<[-4,100]x[-4,100]x[-4,704]xf32>, %timers : !llvm.ptr) {
    ...
    %3, %4 = scf.for %time = %time_m to %2 step %step iter_args(%u_t0 = %u_vec0, %u_t1 = %u_vec1) -> (!stencil.field<[-4,100]x[-4,100]x[-4,704]xf32>, !stencil.field<[-4,100]x[-4,100]x[-4,704]xf32>) {
      %u_t0_temp = stencil.load %u_t0 : !stencil.field<[-4,100]x[-4,100]x[-4,704]xf32> -> !stencil.temp<?x?x?xf32>
      %u_t1_temp = stencil.apply(%u_t0_blk = %u_t0_temp : !stencil.temp<?x?x?xf32>) -> (!stencil.temp<?x?x?xf32>) {
        %dt = arith.constant 3.522598e-07 : f32
        ...
        %h_x = arith.constant 2.105263e-02 : f32
        ...
        %h_x_1 = arith.constant 2.105263e-02 : f32
        ...
        %h_x_2 = arith.constant 2.105263e-02 : f32
        ...
        %h_x_3 = arith.constant 2.105263e-02 : f32
        ...
        %h_x_4 = arith.constant 2.105263e-02 : f32
        ...
        %h_y = arith.constant 2.105263e-02 : f32
        ...
        %h_y_1 = arith.constant 2.105263e-02 : f32
        ...
        %h_y_2 = arith.constant 2.105263e-02 : f32
        ...
        %h_y_3 = arith.constant 2.105263e-02 : f32
        ...
        %h_y_4 = arith.constant 2.105263e-02 : f32
        ...
        %dt_1 = arith.constant 3.522598e-07 : f32
        %115 = arith.mulf %114, %dt_1 : f32
        stencil.return %115 : f32
      }
      stencil.store %u_t1_temp to %u_t1(<[0, 0, 0], [96, 96, 700]>) : !stencil.temp<?x?x?xf32> to !stencil.field<[-4,100]x[-4,100]x[-4,704]xf32>
      %u_t1_temp_1 = stencil.load %u_t1 : !stencil.field<[-4,100]x[-4,100]x[-4,704]xf32> -> !stencil.temp<?x?x?xf32>
      scf.yield %u_t1, %u_t0 : !stencil.field<[-4,100]x[-4,100]x[-4,704]xf32>, !stencil.field<[-4,100]x[-4,100]x[-4,704]xf32>
    }
